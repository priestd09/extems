...
namespace Extems.Academic.Api.Tests
{
    public class SectionTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.Section section = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.Section section = Fixture().GetFirst();
            Assert.NotNull(section);
        }
        ...
        {
            Extems.Academic.Entities.Section section = Fixture().GetPrevious(0);
            Assert.NotNull(section);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.Section section = Fixture().GetNext(0);
            Assert.NotNull(section);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.Section section = Fixture().GetLast();
            Assert.NotNull(section);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.Section> sections = Fixture().Get(new int[] { });
