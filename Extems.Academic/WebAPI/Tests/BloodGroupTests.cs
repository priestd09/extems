...
namespace Extems.Academic.Api.Tests
{
    ...
    {
        public static BloodGroupController Fixture()
        {
            BloodGroupController controller = new BloodGroupController(new BloodGroupRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Academic.Entities.BloodGroup bloodGroup = Fixture().Get(0);
            Assert.NotNull(bloodGroup);
        }
        ...
        public void First()
        {
            Extems.Academic.Entities.BloodGroup bloodGroup = Fixture().GetFirst();
            Assert.NotNull(bloodGroup);
        }
        ...
        {
            Extems.Academic.Entities.BloodGroup bloodGroup = Fixture().GetPrevious(0);
            Assert.NotNull(bloodGroup);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.BloodGroup bloodGroup = Fixture().GetNext(0);
            Assert.NotNull(bloodGroup);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.BloodGroup bloodGroup = Fixture().GetLast();
            Assert.NotNull(bloodGroup);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.BloodGroup> bloodGroups = Fixture().Get(new int[] { });
            Assert.NotNull(bloodGroups);
        }
