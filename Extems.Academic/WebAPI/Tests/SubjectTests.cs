...
namespace Extems.Academic.Api.Tests
{
    public class SubjectTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.Subject subject = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.Subject subject = Fixture().GetFirst();
            Assert.NotNull(subject);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.Subject subject = Fixture().GetNext(0);
            Assert.NotNull(subject);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.Subject> subjects = Fixture().Get(new int[] { });
