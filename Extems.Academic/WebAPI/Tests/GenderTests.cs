...
namespace Extems.Academic.Api.Tests
{
    public class GenderTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.Gender gender = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.Gender gender = Fixture().GetFirst();
            Assert.NotNull(gender);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.Gender gender = Fixture().GetNext(0);
            Assert.NotNull(gender);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.Gender> genders = Fixture().Get(new int[] { });
