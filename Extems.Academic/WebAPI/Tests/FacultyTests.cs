...
namespace Extems.Academic.Api.Tests
{
    public class FacultyTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.Faculty faculty = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.Faculty faculty = Fixture().GetFirst();
            Assert.NotNull(faculty);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.Faculty faculty = Fixture().GetNext(0);
            Assert.NotNull(faculty);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.Faculty> faculties = Fixture().Get(new int[] { });
