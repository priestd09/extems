...
namespace Extems.Academic.Api.Tests
{
    ...
    {
        public static AcademicLevelController Fixture()
        {
            AcademicLevelController controller = new AcademicLevelController(new AcademicLevelRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Academic.Entities.AcademicLevel academicLevel = Fixture().Get(0);
            Assert.NotNull(academicLevel);
        }
        ...
        public void First()
        {
            Extems.Academic.Entities.AcademicLevel academicLevel = Fixture().GetFirst();
            Assert.NotNull(academicLevel);
        }
        ...
        {
            Extems.Academic.Entities.AcademicLevel academicLevel = Fixture().GetPrevious(0);
            Assert.NotNull(academicLevel);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.AcademicLevel academicLevel = Fixture().GetNext(0);
            Assert.NotNull(academicLevel);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.AcademicLevel academicLevel = Fixture().GetLast();
            Assert.NotNull(academicLevel);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.AcademicLevel> academicLevels = Fixture().Get(new int[] { });
            Assert.NotNull(academicLevels);
        }
