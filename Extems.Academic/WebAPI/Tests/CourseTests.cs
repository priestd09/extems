...
namespace Extems.Academic.Api.Tests
{
    public class CourseTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.Course course = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.Course course = Fixture().GetFirst();
            Assert.NotNull(course);
        }
        ...
        {
            Extems.Academic.Entities.Course course = Fixture().GetPrevious(0);
            Assert.NotNull(course);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.Course course = Fixture().GetNext(0);
            Assert.NotNull(course);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.Course course = Fixture().GetLast();
            Assert.NotNull(course);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.Course> courses = Fixture().Get(new int[] { });
