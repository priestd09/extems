...
{
    public class ClassShiftTests
    {
        public static ClassShiftController Fixture()
        {
            ClassShiftController controller = new ClassShiftController(new ClassShiftRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Academic.Entities.ClassShift classShift = Fixture().Get(0);
            Assert.NotNull(classShift);
        }
        ...
        public void First()
        {
            Extems.Academic.Entities.ClassShift classShift = Fixture().GetFirst();
            Assert.NotNull(classShift);
        }
        ...
        {
            Extems.Academic.Entities.ClassShift classShift = Fixture().GetPrevious(0);
            Assert.NotNull(classShift);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.ClassShift classShift = Fixture().GetNext(0);
            Assert.NotNull(classShift);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.ClassShift classShift = Fixture().GetLast();
            Assert.NotNull(classShift);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.ClassShift> classShifts = Fixture().Get(new int[] { });
            Assert.NotNull(classShifts);
        }
