...
namespace Extems.Academic.Api.Tests
{
    public class HouseTests
    {
        ...
        public void Get()
        {
            Extems.Academic.Entities.House house = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Academic.Entities.House house = Fixture().GetFirst();
            Assert.NotNull(house);
        }
        ...
        {
            Extems.Academic.Entities.House house = Fixture().GetPrevious(0);
            Assert.NotNull(house);
        }
        ...
        public void Next()
        {
            Extems.Academic.Entities.House house = Fixture().GetNext(0);
            Assert.NotNull(house);
        }
        ...
        public void Last()
        {
            Extems.Academic.Entities.House house = Fixture().GetLast();
            Assert.NotNull(house);
        }
        ...
        {
            IEnumerable<Extems.Academic.Entities.House> houses = Fixture().Get(new int[] { });
