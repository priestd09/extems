...
{
    public class ScholorshipTypeTests
    {
        ...
        public void Get()
        {
            Extems.Admission.Entities.ScholorshipType scholorshipType = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Admission.Entities.ScholorshipType scholorshipType = Fixture().GetFirst();
            Assert.NotNull(scholorshipType);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.ScholorshipType scholorshipType = Fixture().GetNext(0);
            Assert.NotNull(scholorshipType);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.ScholorshipType> scholorshipTypes = Fixture().Get(new int[] { });
            Assert.NotNull(scholorshipTypes);
        }
