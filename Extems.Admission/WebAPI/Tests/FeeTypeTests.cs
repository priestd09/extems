...
namespace Extems.Admission.Api.Tests
{
    ...
    {
        public static FeeTypeController Fixture()
        {
            FeeTypeController controller = new FeeTypeController(new FeeTypeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Admission.Entities.FeeType feeType = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Admission.Entities.FeeType feeType = Fixture().GetFirst();
            Assert.NotNull(feeType);
        }
        ...
        {
            Extems.Admission.Entities.FeeType feeType = Fixture().GetPrevious(0);
            Assert.NotNull(feeType);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.FeeType feeType = Fixture().GetNext(0);
            Assert.NotNull(feeType);
        }
        ...
        public void Last()
        {
            Extems.Admission.Entities.FeeType feeType = Fixture().GetLast();
            Assert.NotNull(feeType);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.FeeType> feeTypes = Fixture().Get(new int[] { });
            Assert.NotNull(feeTypes);
        }
