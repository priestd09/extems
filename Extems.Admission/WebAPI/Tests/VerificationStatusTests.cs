...
namespace Extems.Admission.Api.Tests
{
    public class VerificationStatusTests
    {
        ...
        public void Get()
        {
            Extems.Admission.Entities.VerificationStatus verificationStatus = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Admission.Entities.VerificationStatus verificationStatus = Fixture().GetFirst();
            Assert.NotNull(verificationStatus);
        }
        ...
        {
            Extems.Admission.Entities.VerificationStatus verificationStatus = Fixture().GetPrevious(0);
            Assert.NotNull(verificationStatus);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.VerificationStatus verificationStatus = Fixture().GetNext(0);
            Assert.NotNull(verificationStatus);
        }
        ...
        public void Last()
        {
            Extems.Admission.Entities.VerificationStatus verificationStatus = Fixture().GetLast();
            Assert.NotNull(verificationStatus);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.VerificationStatus> verificationStatuses = Fixture().Get(new short[] { });
