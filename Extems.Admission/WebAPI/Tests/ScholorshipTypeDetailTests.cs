...
{
    public class ScholorshipTypeDetailTests
    {
        ...
        public void Get()
        {
            Extems.Admission.Entities.ScholorshipTypeDetail scholorshipTypeDetail = Fixture().Get(0);
            Assert.NotNull(scholorshipTypeDetail);
        }
        ...
        public void First()
        {
            Extems.Admission.Entities.ScholorshipTypeDetail scholorshipTypeDetail = Fixture().GetFirst();
            Assert.NotNull(scholorshipTypeDetail);
        }
        ...
        {
            Extems.Admission.Entities.ScholorshipTypeDetail scholorshipTypeDetail = Fixture().GetPrevious(0);
            Assert.NotNull(scholorshipTypeDetail);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.ScholorshipTypeDetail scholorshipTypeDetail = Fixture().GetNext(0);
            Assert.NotNull(scholorshipTypeDetail);
        }
        ...
        public void Last()
        {
            Extems.Admission.Entities.ScholorshipTypeDetail scholorshipTypeDetail = Fixture().GetLast();
            Assert.NotNull(scholorshipTypeDetail);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.ScholorshipTypeDetail> scholorshipTypeDetails = Fixture().Get(new int[] { });
            Assert.NotNull(scholorshipTypeDetails);
        }
