...
namespace Extems.Admission.Api.Tests
{
    ...
    {
        public static AdmissionApplicationController Fixture()
        {
            AdmissionApplicationController controller = new AdmissionApplicationController(new AdmissionApplicationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Admission.Entities.AdmissionApplication admissionApplication = Fixture().Get(0);
            Assert.NotNull(admissionApplication);
        }
        ...
        public void First()
        {
            Extems.Admission.Entities.AdmissionApplication admissionApplication = Fixture().GetFirst();
            Assert.NotNull(admissionApplication);
        }
        ...
        {
            Extems.Admission.Entities.AdmissionApplication admissionApplication = Fixture().GetPrevious(0);
            Assert.NotNull(admissionApplication);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.AdmissionApplication admissionApplication = Fixture().GetNext(0);
            Assert.NotNull(admissionApplication);
        }
        ...
        public void Last()
        {
            Extems.Admission.Entities.AdmissionApplication admissionApplication = Fixture().GetLast();
            Assert.NotNull(admissionApplication);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.AdmissionApplication> admissionApplications = Fixture().Get(new long[] { });
            Assert.NotNull(admissionApplications);
        }
