...
namespace Extems.Admission.Api.Tests
{
    ...
    {
        public static AdmissionController Fixture()
        {
            AdmissionController controller = new AdmissionController(new AdmissionRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            Extems.Admission.Entities.Admission admission = Fixture().Get(0);
        ...
        public void First()
        {
            Extems.Admission.Entities.Admission admission = Fixture().GetFirst();
            Assert.NotNull(admission);
        }
        ...
        {
            Extems.Admission.Entities.Admission admission = Fixture().GetPrevious(0);
            Assert.NotNull(admission);
        }
        ...
        public void Next()
        {
            Extems.Admission.Entities.Admission admission = Fixture().GetNext(0);
            Assert.NotNull(admission);
        }
        ...
        public void Last()
        {
            Extems.Admission.Entities.Admission admission = Fixture().GetLast();
            Assert.NotNull(admission);
        }
        ...
        {
            IEnumerable<Extems.Admission.Entities.Admission> admissions = Fixture().Get(new long[] { });
