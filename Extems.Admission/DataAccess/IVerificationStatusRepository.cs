...
namespace Extems.Admission.DataAccess
{
    public interface IVerificationStatusRepository
    {
        ...
        IEnumerable<Extems.Admission.Entities.VerificationStatus> GetAll();
        ...
        Extems.Admission.Entities.VerificationStatus Get(short verificationStatusId);

        /// <summary>
        /// Gets the first record of VerificationStatus.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of VerificationStatus.</returns>
        Extems.Admission.Entities.VerificationStatus GetFirst();
        ...
        /// <returns>Returns a non-live, non-mapped instance of VerificationStatus.</returns>
        Extems.Admission.Entities.VerificationStatus GetPrevious(short verificationStatusId);
        ...
        /// <returns>Returns a non-live, non-mapped instance of VerificationStatus.</returns>
        Extems.Admission.Entities.VerificationStatus GetNext(short verificationStatusId);

        /// <summary>
        /// Gets the last record of VerificationStatus.
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of VerificationStatus.</returns>
        Extems.Admission.Entities.VerificationStatus GetLast();
        ...
        IEnumerable<Extems.Admission.Entities.VerificationStatus> Get(short[] verificationStatusIds);
        ...
        object AddOrEdit(dynamic verificationStatus, List<Frapid.DataAccess.Models.CustomField> customFields);
        ...
        IEnumerable<Extems.Admission.Entities.VerificationStatus> GetPaginatedResult();
        ...
        IEnumerable<Extems.Admission.Entities.VerificationStatus> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of VerificationStatus class.</returns>
        IEnumerable<Extems.Admission.Entities.VerificationStatus> GetWhere(long pageNumber, List<Frapid.DataAccess.Models.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of VerificationStatus class.</returns>
        IEnumerable<Extems.Admission.Entities.VerificationStatus> GetFiltered(long pageNumber, string filterName);
